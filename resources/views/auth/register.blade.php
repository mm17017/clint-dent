            ...
            <div class="">
                ...
                <div class="card-body contenedor sombra gradiente-form">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right color-blanco">{{ __('E-Mail Address') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right color-blanco">{{ __('Confirma tú contraseña') }}</label>
